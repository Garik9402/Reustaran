...
var spoilersNode = document.querySelectorAll('.spoiler');
var spoilersArrowsNode = document.querySelectorAll('.spoiler__arrow');
var spoilerList = document.querySelectorAll('.sloiler__list');
spoilersNode.forEach(function (elem) {
  elem.addEventListener('click', function () {
    spoilersNode.forEach(function (e) {
...
var sharesItemNode = document.querySelectorAll('.shares__nav-item-link');
sharesItemNode.forEach(function (elem) {
  elem.addEventListener('click', function () {
    sharesItemNode.forEach(function (el) {
...
var productsListItemNode = document.querySelectorAll('.products__list-item');
productsListItemNode.forEach(function (el) {
...
var addressNameNode = document.querySelectorAll('.address-menu__nav-item-link');
var addresSvgNode = document.querySelectorAll('.address-menu__svg');
...
var addressAddNode = document.querySelector('.add-address--js-open');
var locationSearchNode = document.querySelector('.popup-location-w');
var closeLocationNode = document.querySelector('.popup-location__close');
var addressNode = document.querySelector('.address');
var addressMenuNode = document.querySelector('.address-menu');
...
var callNode = document.querySelector('.call');
var phonesMenuNode = document.querySelector('.phones');
window.addEventListener('click', function (event) {
...
var cardItemNode = document.querySelectorAll('.card');
var sliderCardNode = document.querySelector('.popup-cards');
var sliderCloseNode = document.querySelectorAll('.popup-card__close');
window.addEventListener('click', function (event) {
...
var sliderListNode = document.querySelector('.popup-cards__slider-list');
var nextCardNode = document.querySelector('.popup-cards__arrow-next');
var prevCardNode = document.querySelector('.popup-cards__arrow-prev');
var size = 0;
...
var additionalProduct = document.querySelectorAll('.popup-product__product');
...
var dropdownInfo = document.querySelectorAll('.popup-product__info');
dropdownInfo.forEach(function (el) {
  el.addEventListener('click', function () {
    dropdownInfo.forEach(function (e) {
...
var popupProductNode = document.querySelectorAll('.popup-product');
productNode.forEach(function (el) {
  el.addEventListener('click', function () {
    var index = this.dataset.id;
    popupProductNode.forEach(function (e) {
      e.classList.remove('popup-product--js-open');
    });
    popupProductNode[index].classList.add('popup-product--js-open');
  });
});
var productCloseNode = document.querySelectorAll('.popup-product__close');
window.addEventListener('click', function (event) {
  productCloseNode.forEach(function (el) {
    if (el.contains(event.target)) {
      popupProductNode.forEach(function (el) {
